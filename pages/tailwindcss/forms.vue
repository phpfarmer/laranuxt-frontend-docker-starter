        ...
        <div class="mt-8 max-w-md">
          <div class="grid grid-cols-1 gap-6">
            <label class="block">
              ...
              <input class="mt-1 block w-full" placeholder="" type="text">
            </label>
            <label class="block">
              <span class="text-gray-700">Email address</span>
              <input class="mt-1 block w-full" placeholder="john@example.com" type="email">
            </label>
            <label class="block">
              <span class="text-gray-700">When is your event?</span>
              <input class="mt-1 block w-full" type="date">
            </label>
            <label class="block">
